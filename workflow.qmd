...
This page is the *narrative* of a session. For looking a single task up while you work — "how do I reverse-code an item," "how do I get a correlation matrix" — see the [Reference](reference.qmd) page, which links every function to its full help. And when you're ready to go further than these guides: Book 1 builds the statistics and R together from the start, and Book 2 is the option-by-option guide for readers who already know the statistics.
