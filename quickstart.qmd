...
That practice dataset, **`community`**, holds 100 simulated community-survey respondents,
...
data of your own is covered in [jstats with your own data](your-data.qmd).
...
next part is about: [jstats with your own data](your-data.qmd).
:::
